...
app.use(session({ secret: 'microblogging', cookie: { maxAge: 60000 }, resave: false, saveUninitialized: false }));
...
if(isProduction){
  ...
  mongoose.connect('mongodb+srv://ibukunoluwa:J37XqVAVWWW6T9R@cluster0.8j0zg.mongodb.net/test?retryWrites=true&w=majority');
